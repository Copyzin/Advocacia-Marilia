...
<p>Vale lembrar que a abertura do inventário deve ocorrer em até 60 dias do falecimento para evitar multa sobre o ITCMD em São Paulo. Mesmo famílias em consenso se beneficiam de orientação desde o início, para escolher a via adequada e não perder prazos fiscais.</p>`,
    },
    {
        ...
        body: `
<p>A compra de um imóvel costuma ser a maior transação financeira da vida de uma família. Ainda assim, é comum que o contrato seja assinado sem uma análise jurídica prévia — e problemas que custariam pouco para prevenir acabam custando caro para remediar.</p>
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Playfair+Display:ital,wght@0,400..700;1,400..700&display=swap" rel="stylesheet">
    ...
    <nav class="navbar scrolled" id="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="${p}blog/" class="nav-item">Blog</a></li>
                <li><a href="${p}index.html#contato" class="nav-item">Contato</a></li>
            </ul>

            <a href="${WA}" target="_blank" rel="noopener noreferrer" class="nav-whatsapp" aria-label="Fale conosco no WhatsApp">
                ...
                <span class="nav-whatsapp-text">Fale Conosco</span>
            </a>
        </div>
    </nav>
        ...
        <div class="wa-panel" id="waPanel" role="dialog" aria-label="Atendimento Advocacia Marília">
            <header class="wa-panel-header">
                <div class="wa-brand">
                    ...
                    <span class="wa-brand-status">Atendimento Digital</span>
                </div>
            </header>
            ...
            <footer class="wa-panel-footer">
                <a href="${WA}" target="_blank" rel="noopener noreferrer" class="wa-direct-link">Falar no WhatsApp</a>
            </footer>
        </div>
    </div>

    <script src="${p}script.js?v=${JS_V}"></script>
</body>
</html>
`;
}
...
${a.body.trim()}
            ...
            <div class="article-cta">
                <a href="${WA}" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Falar com um Advogado</a>
